...
exports.handler = (event, context, callback) => {
    ...
    const validLocations = ['new york'];  // for assignment 3
          ...
          dialogAction: {
            type: "ElicitSlot",
             message: {
               ...
               content: 'We currently only support New York. Please enter New York'
            },
    ...
    const validCuisines = ["mediterranean", "mexican", "italian", "indian", "chinese", "thai", "japanese", "greek", "american"];
        ...
        let response = { sessionAttributes: event.sessionAttributes,
          dialogAction: {
            type: "ElicitSlot",
             message: {
               contentType: "PlainText",
               content: `Please choose from Mediterranean, Mexican, Italian, Indian, Chinese, Thai, Japanese, Greek, or American.`
            },
             intentName: event.currentIntent.name,
             slots: slots,
